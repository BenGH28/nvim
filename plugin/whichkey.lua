...
local nmappings = {
  ["."] = {":tabn<cr>", "next"},
  [","] = {":tabp<cr>", "previous"},
  ["1"] = {":BufferLineGoToBuffer 1", "Goto buffer 1"},
  ["2"] = {":BufferLineGoToBuffer 2", "Goto buffer 2"},
  ["3"] = {":BufferLineGoToBuffer 3", "Goto buffer 3"},
  ["4"] = {":BufferLineGoToBuffer 4", "Goto buffer 4"},
  ["5"] = {":BufferLineGoToBuffer 5", "Goto buffer 5"},
  ["6"] = {":BufferLineGoToBuffer 6", "Goto buffer 6"},
  ["7"] = {":BufferLineGoToBuffer 7", "Goto buffer 7"},
  ["8"] = {":BufferLineGoToBuffer 8", "Goto buffer 8"},
  ["9"] = {":BufferLineGoToBuffer 9", "Goto buffer 9"},
  b = {
    name = "+buffers",
    n = {":bNext<cr>", "next"},
